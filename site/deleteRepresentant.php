...
if (isset($_GET['User_ID'])) {
    ...
    if (isset($_GET['confirm'])) {
        if ($_GET['confirm'] == 'yes') {
            ...
            header('Location: manageRepresentant.php');
            exit;
        }
    }
} else {
...
<html lang='en'>
    ...
    <title>Delete Representant</title>
...
<div class="back" <input type="submit" value="Back" onclick="window.location.href='manageRepresentant.php'"><span>Back</span></div>
    ...
    <div class="yesno">
        <a href="deleteRepresentant.php?User_ID=<?=$user['User_ID']?>&confirm=yes">Yes</a>
        <a href="deleteRepresentant.php?User_ID=<?=$user['User_ID']?>&confirm=no">No</a>
    </div>
    <?php endif; ?>
</div>
</main>
